...
#DATASET_DIR = "/home/mushfiqrahman/dataset/db_numpy/samples_20frames_1ts/"
#MODEL_DIR = "/home/mushfiqrahman/dataset/db_numpy/ds/convlstm_recur_seq_model_1ts_wbce/"

#DATASET_DIR = "/home/mushfiqrahman/dataset/db_numpy/samples_10frames_1ts/"
#MODEL_DIR = "/home/mushfiqrahman/dataset/db_numpy/ds/convlstm_recur_seq_model_1ts_wbce/"
#MODEL_DIR = "/home/mushfiqrahman/dataset/db_numpy/ds/convlstm_recur_seq_model_1ts_wbce_20ep/"
#MODEL_DIR = "/home/mushfiqrahman/dataset/db_numpy/ds/convlstm_recur_seq_model_1ts_wbce_25ep/"
#MODEL_DIR = "/home/mushfiqrahman/dataset/db_numpy/ds/convlstm_recur_seq_model_1ts_wbce_beta/"
#MODEL_DIR = "/home/mushfiqrahman/dataset/db_numpy/ds/convlstm_recur_seq_model_1ts_wbce_2/"
#MODEL_DIR = "/home/mushfiqrahman/dataset/db_numpy/ds/convlstm_recur_seq_model_1ts_wbce_bd_att/"

#MODEL_DIR = "/home/mushfiqrahman/dataset/db_numpy/ds/convlstm_recur_seq_model_1ts_wbce_test/"

#for 2ts
DATASET_DIR = "/home/mushfiqrahman/dataset/db_numpy/samples_10frames_2ts/"
MODEL_DIR = "/home/mushfiqrahman/dataset/db_numpy/ds/convlstm_recur_seq_model_2ts_wbce/"
#MODEL_DIR = "/home/mushfiqrahman/dataset/db_numpy/ds/convlstm_recur_seq_model_2ts_wbce_30ep/"
...
'''
# 1 time step ahead 20 frames prediction
TOTAL_SAMPLES = 4584
TRAIN_SAMPLES = 4000
VALIDATION_SAMPLES = 500
TEST_SAMPLES = 84
...
def encoder_net(x, frameno, mode, convlstm1_s, convlstm2_s, convlstm3_s):
...
def upsampling_network(lstm_output_cur, feat_shape, skip1, skip2, skip3, seq, mode):
    with tf.device('/gpu:0'):
        ...
        rskip3, _ = recurrent_skip(up1, None, 'skip_convlstm1_'+str(seq))
        ...
        rskip2, _ = recurrent_skip(up2, None, 'skip_convlstm2_'+str(seq))
        ...
        rskip1, _ = recurrent_skip(up3, None, 'skip_convlstm3_'+str(seq))
...
def build_model(input_stack, mode):
    ...
    for inp in range(0, len(input_stack)):
        skip1, convlstm1_s, skip2, convlstm2_s, skip3, convlstm3_s, enc_output = encoder_net(input_stack[inp], inp+1, mode, convlstm1_s, convlstm2_s, convlstm3_s)
    ...
    dec_input = encoder_output[-1]
    print('Decoder - ConvLSTM ........')
    print('DECODER NETWORK... Xn+1 time frame')
    dec_convlstm_o, dec_convlstm_s = decoder_lstm(dec_input, enc_convlstm_s, 1, mode)
    feat_shape = enc_convlstm_s.h.get_shape().as_list()[1:]
    logit, pred, skip1, skip2, skip3 = upsampling_network(dec_convlstm_o, feat_shape, skip1, skip2, skip3, 1, mode)
    logits.append(logit)
    preds.append(pred)

    print('DECODER NETWORK... Xn+2 time frame')
    dec_convlstm_o, dec_convlstm_s = decoder_lstm(dec_convlstm_o, dec_convlstm_s, 2, mode)
    logit, pred, skip1, skip2, skip3 = upsampling_network(dec_convlstm_o, feat_shape, skip1, skip2, skip3, 2, mode)
    logits.append(logit)
    preds.append(pred)

    print('DECODER NETWORK... Xn+3 time frame')
    dec_convlstm_o, dec_convlstm_s = decoder_lstm(dec_convlstm_o, dec_convlstm_s, 3, mode)
    logit, pred, skip1, skip2, skip3 = upsampling_network(dec_convlstm_o, feat_shape, skip1, skip2, skip3, 3, mode)
    logits.append(logit)
    preds.append(pred)

    print('DECODER NETWORK... Xn+4 time frame')
    dec_convlstm_o, dec_convlstm_s = decoder_lstm(dec_convlstm_o, dec_convlstm_s, 4, mode)
    logit, pred, skip1, skip2, skip3 = upsampling_network(dec_convlstm_o, feat_shape, skip1, skip2, skip3, 4, mode)
    logits.append(logit)
    preds.append(pred)

    print('DECODER NETWORK... Xn+5 time frame')
    dec_convlstm_o, dec_convlstm_s = decoder_lstm(dec_convlstm_o, dec_convlstm_s, 5, mode)
    logit, pred, skip1, skip2, skip3 = upsampling_network(dec_convlstm_o, feat_shape, skip1, skip2, skip3, 5, mode)
    logits.append(logit)
    preds.append(pred)
...
def main(unused_argv):
    ...
    with tf.Graph().as_default(), tf.device('/gpu:0'):
        ...
        logits, preds = build_model(input_stack, mode)
        ...
        if mode != 'test':
            ...
            # weighted bce
            loss1 = weighted_bce_loss(label1, pred1)
            loss2 = weighted_bce_loss(label2, pred2)
            loss3 = weighted_bce_loss(label3, pred3)
            loss4 = weighted_bce_loss(label4, pred4)
            loss5 = weighted_bce_loss(label5, pred5)
